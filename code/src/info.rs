        ...
        <Columns>
            <Column size={ColumnSize::Is6}>
                ...
                <Content>
                    ...
                    <p style="hyphens:auto"> {" Dit is een pilootproject dat streeft naar standardisatie van het \
                    ...
                    <h3> {"Gebruik"} </h3>
                    <p style="hyphens:auto"> {"Om een schatting te krijgen moeten er eerst enkele parameters ingegeven worden.\
                    ...
                    <p style="hyphens:auto"> {"Indien bijvoorbeeld melk uit de koelkast warmer lijkt dan gewoonlijk kan men voor de beste \
                    ...
                    <p style="hyphens:auto"> {"De locatie van de spuit in de microgolf is enorm belangrijk, dit programma gaat ervan uit \
                    ...
                    <h3> {"Accuraatheid"} </h3>
                    <p style="hyphens:auto"> {"Een schatting van de temperatuur wordt gegeven bij elke verandering."} </p>
                    <p style="hyphens:auto"> {"De berekening van het opwarmen zelf is accuraat tot ±2 graden, \
                    de grootste variatie komt door het verschil van temperatuur uit de koelkast."} </p>

                    <p style="hyphens:auto"> {"Kleine volumes zijn minder accuraat omdat hier meerdere factoren een rol spelen \
                     die moeilijk te meten zijn. Daarom zal de aangegeven spreiding groter zijn."} </p>

                    <h3> {"Toekomst"} </h3>
                    <p style="hyphens:auto"> {"Er zijn nog verschillende ideeën en optimalisaties die onderzocht kunnen worden."}</p>

                    <p style="hyphens:auto"> {"Het is bijvoorbeeld niet zeker wat de beste ligging is van de spuiten in de microgolf. \
                    ...
                    <p style="hyphens:auto"> {"Bij het opwarmen van materialen wordt er meestal van uitgegaan dat de opwarming lineair is, \
                    ...
                    <p style="hyphens:auto"> {"Om tijd te besparen is het vaak nuttig om meerdere spuiten tesamen in de microgolf te leggen. \
